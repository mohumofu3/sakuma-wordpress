		...
		<main <?php st_text_copyck(); ?>>
			<div class="post" id="st-page">
				...
				<?php if (!is_front_page()) { ?>
					...
					?>
						<div class="nowhits hits-front-eye"><?php get_template_part('popular-thumbnail'); //任意のエントリ 
																								?></div>
					<?php } else { //アイキャッチがない場合 
					?>
						<div class="nowhits hits-front"><?php get_template_part('popular-thumbnail'); //任意のエントリ 
																						?></div>
					<?php } ?>
